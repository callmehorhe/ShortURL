...
type URLClient interface {
	Create(ctx context.Context, in *UrlMessage, opts ...grpc.CallOption) (*UrlMessage, error)
	Get(ctx context.Context, in *UrlMessage, opts ...grpc.CallOption) (*UrlMessage, error)
}
...
func (c *uRLClient) Create(ctx context.Context, in *UrlMessage, opts ...grpc.CallOption) (*UrlMessage, error) {
	out := new(UrlMessage)
...
func (c *uRLClient) Get(ctx context.Context, in *UrlMessage, opts ...grpc.CallOption) (*UrlMessage, error) {
	out := new(UrlMessage)
	err := c.cc.Invoke(ctx, "/api.URL/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type URLServer interface {
	Create(context.Context, *UrlMessage) (*UrlMessage, error)
	Get(context.Context, *UrlMessage) (*UrlMessage, error)
...
func (UnimplementedURLServer) Create(context.Context, *UrlMessage) (*UrlMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedURLServer) Get(context.Context, *UrlMessage) (*UrlMessage, error) {
...
func _URL_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(URLServer).Create(ctx, req.(*UrlMessage))
	}
...
func _URL_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.URL/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(URLServer).Get(ctx, req.(*UrlMessage))
	}
	return interceptor(ctx, in, info, handler)
}
